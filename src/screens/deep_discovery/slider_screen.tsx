...
import { useDeepDiscoverContext } from "./deep-discover-context";

const SliderScreen = () => {
  const navigation = useNavigation();
  const [value, setValue] = useState(15);
  const { setTime } = useDeepDiscoverContext();

  return (
    <ScreenWrapper backgroundType="gray" paddingHorizontal="small">
      <View style={styles.header}>
        <Text style={styles.headerTitle}>Deep Discovery</Text>
        <TouchableOpacity
      ...
      <View style={styles.container}>
        ...
        <View style={styles.labelsContainer}>
          ...
          <Text style={styles.label}>60 mins</Text>
        </View>
      </View>
      <View style={styles.buttonsContainer}>
        <TouchableOpacity
          style={styles.saveButton}
          onPress={() => navigation.navigate(SCREENS.DEEP_DISCOVERY_TIMER)}
        >
