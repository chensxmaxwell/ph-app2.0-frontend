    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.InfoContainer}>
                <Text style={styles.InfoLabel}>Yay!</Text>
                <Text style={styles.InfoLabel2}>Your password has been set up successfully.</Text>
            </View>

            <TouchableOpacity style={styles.loginButton} onPress={handleNavigateToRegisterProfile}>
