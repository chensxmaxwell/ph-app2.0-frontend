...
const ResetEmailVerificationScreen = () => {
  const [verificationCode, setVerificationCode] = useState("");

  const handleVerify = () => {
    navigation.navigate(SCREENS.PROFILE_SETTING_ACCOUNT_RESET_EMAIL_SUCCESS);
  };
      ...
      <View style={styles.container}>
        <View style={styles.topSection}>
          <View style={styles.descriptionContainer}>
            <Text style={styles.description}>Please verify your email.</Text>
...
export default ResetEmailVerificationScreen;
