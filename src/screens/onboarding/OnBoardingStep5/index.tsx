    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.infoContainer}>
                <Text style={styles.info}>Setup Complete</Text>
            </View>
            ...
            <View style={styles.instructionContainer}>
                <Text style={styles.instruction}>Your device is now connected and ready to use</Text>
            </View>

            <TouchableOpacity style={styles.continueButton} onPress={handleNavigateToOnBoarding6}>
